defmodule MyappWeb.UserControllerTest do
  ...
  @create_attrs %{nDepartmentIdn: 42, nEndDate: 42, nStartDate: 42, sEmail: "some sEmail", sTelNumber: "some sTelNumber", sUserID: "some sUserID", sUserName: "some sUserName"}
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert html_response(conn, 200) =~ "some updated sEmail"
    end
